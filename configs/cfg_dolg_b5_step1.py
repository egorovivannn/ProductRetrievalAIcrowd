...
cfg.eval_every = 1
# cfg.ckpt = 'my_submission/model.ckpt'
cfg.data_path = '/media/ivan/Data1/hack_ai/classif/'
...
cfg.val_aicrowd = False # if val on aicrowd data
...
cfg.train_csv_path = cfg.data_path+'/train.csv'
try:
    ...
    cfg.n_classes = len(df['label_idx'].unique())
    cfg.df = df
